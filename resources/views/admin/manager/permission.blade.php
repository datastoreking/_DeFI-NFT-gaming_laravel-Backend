        ...
        <form class="layui-form col-lg-5">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="checkbox" name="permission[{{$module->module}}][]" @if(isset($permissions[$module->module]) && in_array($action->action, $permissions[$module->module])) checked @endif title="{{$action->name}}" value="{{$action->action}}">
                    @endforeach
                </div>
