    ...
    <div class="layui-form">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="month" id="month" placeholder="请选择月份" autocomplete="off" class="layui-input" value="" >
            </div>
        </div>
    ...
    <script type="text/javascript">
        window.onload = function () {
            layui.use(['layer', 'table','form','laydate'], function () { //独立版的layer无需执行这一句
                ...
                function tbRend(url) {
                    table.render({
                        ...
                        cols: [[
                            ...
                            {field: 'num', title: '消费金额', minWidth: 150},
                        ]],
                ...
                tbRend("{{url('/admin/consume_total_month_list')}}");
                $("#search").click(function() {
                    var month = $("#month").val();
                    tbRend("{{url('/admin/consume_total_month_list')}}?month=" + month);
                    return false;
                });
                //监听工具条
