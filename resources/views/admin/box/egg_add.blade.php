                    ...
                    @if(!empty($goods))
                        @foreach($goods as $value)
                            <tr>
                                ...
                                <td><input type='text' style="width: 120px;" name='number[]' class="number" value='{{$value->number}}'></td>
                                <td><input type='text' style="width: 120px;" name='is_special[]' class="is_special" value='{{$value->is_special}}'></td>
        ...
        layui.use(['form','upload','layer'], function () {
            ...
            $("#search_goods").on('click',function () {
                ...
                layer.open({
                    ...
                    ,shade: 0
                    ,maxmin: false
                    ,content:"{{url('admin/goods_egg_search')}}"
                });
            });
