...
return [
    ...
    'wechat' => [
        ...
        // 小程序 APPID
        'miniapp_id' => env('WECHAT_MINIAPP_ID', 'wxbd5bd707ec29ba13'),

        // APP 引用的 appid
        'appid' => env('WECHAT_APPID', 'wx3bcfa188fa4437ed'),

        // 微信支付分配的微信商户号
        'mch_id' => env('WECHAT_MCH_ID', '1603744576'),

        // 微信支付异步通知地址
        'notify_url' => 'https://groupmall.hngpkj.cn/api/wechatNotify',

        // 微信支付签名秘钥
        'key' => env('WECHAT_KEY', 'dwakjdksjdkhwaoldhsouhdsapwasdhw'),
