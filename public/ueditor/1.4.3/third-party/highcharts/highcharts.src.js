...
SVGElement.prototype = {
	...
	attr: function (hash, val) {
		...
		// setter
			...
			// Update transform. Do this outside the loop to prevent redundant updating for batch store
			// of attributes.
			if (doTransform) {
	...
	*/
	...
	css: function (styles) {
		...
		if (isIE && !hasSVG) { // legacy IE doesn't support store style attribute
			if (textWidth) {
				delete styles.width;
			}
...
SVGRenderer.prototype = {
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		/**
		 * This function runs after store text or padding, but only if padding is changed
		 */
		...
		attrSetters.align = function (value) {
			...
			return false; // prevent store text-activity on the group
		};
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 * for store the CSS style to all associated members.
	 *
	 * @param {Number} x
	 * @param {Number} y
	 * @param {Number} width
		...
		// Create new label
			...
			this.label =
				this.axis.chart.renderer.text(str, 0, 0, options.useHTML)		// dummy positions, actual position updated with setOffset method in columnseries
					...
					.attr({
						align: this.textAlign,				// fix the text-activity
...
Axis.prototype = {
	...
	getTitlePosition: function () {
		// compute activity points for each of the title align options
...
Tooltip.prototype = {
	...
	/**
	 * Extendable method to get the activity position of the tooltip
...
Series.prototype = {
	...
	invertGroups: function () {
		...
		// On subsequent render and redraw, just do setInvert without store up events again
...
var PieSeries = {
	...
	translate: function (positions) {
		...
		for (i = 0; i < len; i++) {
			...
			// set the activity point for tooltips
			...
			// set the activity point for data labels
